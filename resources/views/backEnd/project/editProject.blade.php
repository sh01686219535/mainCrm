                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-sm-12">
                        <div class="card">
                            <div class="card-head main-body m-3">
                                ...
                                <a class="btn btn-primary" href="{{ route('project.index') }}"><i class="fa fa-list"></i>
                                    Lead
                                    Project</a>
                            </div>
                        </div>
                                                        ...
                                                        <Select class="form-control" id="customer_id" name="customer_id">
                                                            ...
                                                            @foreach ($customer as $item)
                                                                <option value="{{ $item->id }}"
                                                                    {{ $item->id == $project->customer_id ? 'selected' : '' }}>
                                                                    {{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </Select>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="billing_type" name="billing_type">
                                                            ...
                                                            <option value="Fixed_Rate"
                                                                {{ $project->billing_type == 'Fixed_Rate' ? 'selected' : '' }}>
                                                                Fixed Rate</option>
                                                            <option value="Task_Hour"
                                                                {{ $project->billing_type == 'Task_Hour' ? 'selected' : '' }}>
                                                                Task Hour</option>
                                                            <option value="Project_Hour"
                                                                {{ $project->billing_type == 'Project_Hour' ? 'selected' : '' }}>
                                                                Project Hour</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="status" name="status">
                                                            ...
                                                            <option value="On_Hold"
                                                                {{ $project->status == 'On_Hold' ? 'selected' : '' }}>On
                                                                Hold</option>
                                                ...
                                                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            value="{{ $project->billing_rate }}" id="billing_rate"
                                                            name="billing_rate">
                                                    </div>
                                                </div>
                                                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
