<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
        @if (isset($setting->componyLogoMenu))
            <img src="{{ asset($setting->componyLogoMenu) }}" alt="AdminLTE Logo"
                class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">{{ $setting->companyName }}</span>
        @else
            <img src="" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">Megnetic Codes</span>
        @endif
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    {{-- customer start --}}
                    <li
                        class="nav-item {{ request()->routeIs('customer*') ? 'menu-open' : '' }} || {{ request()->routeIs('approve.customer*') ? 'menu-open' : '' }} || {{ request()->routeIs('customer.list*') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('customer*') ? 'active' : '' }} || {{ request()->routeIs('approve.customer*') ? 'active' : '' }} || {{ request()->routeIs('customer.list*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('approve.customer') }}"
                                    class="nav-link {{ request()->routeIs('approve.customer') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('vendor.index') }}"
                                    class="nav-link {{ request()->routeIs('vendor.index') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Vendor List</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('lead.index') }}"
                                    class="nav-link {{ request()->routeIs('lead.index') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lead List</p>
                                </a>
                            </li>
                    ...
                    {{-- Sales start --}}
                    <li
                        class="nav-item {{ request()->routeIs('invoice.index*') ? 'menu-open' : '' }} || {{ request()->routeIs('estimates.index*') ? 'menu-open' : '' }} 
                    || {{ request()->routeIs('item.index*') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('invoice.index*') ? 'active' : '' }} || {{ request()->routeIs('estimates.index*') ? 'active' : '' }} 
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('item.index') }}"
                                    class="nav-link {{ request()->routeIs('item.index') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Item</p>
                                </a>
                            </li>
                    ...
                    {{-- Expense start --}}
                    <li
                        class="nav-item {{ request()->routeIs('category.index*') ? 'menu-open' : '' }} || {{ request()->routeIs('expense.index*') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('category.index*') ? 'active' : '' }} || {{ request()->routeIs('expense.index*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('expense.index') }}"
                                    class="nav-link {{ request()->routeIs('expense.index') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Expense</p>
                                </a>
                            </li>
                    ...
                    {{-- Employee Start --}}
                    <li
                        class="nav-item {{ request()->routeIs('teamLeader*') ? 'menu-open' : '' }} || {{ request()->routeIs('sales.person*') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('teamLeader*') ? 'active' : '' }} || {{ request()->routeIs('sales.person*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('teamLeader') }}"
                                    class="nav-link {{ request()->routeIs('teamLeader') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Team Leader</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('sales.person') }}"
                                    class="nav-link {{ request()->routeIs('sales.person*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sales Person</p>
                                </a>
                            </li>
                    ...
                    {{-- Report Start --}}
                    <li
                        class="nav-item {{ request()->routeIs('task.report*') ? 'menu-open' : '' }} || {{ request()->routeIs('customerLead.report*') ? 'menu-open' : '' }}
                     || {{ request()->routeIs('expense.report*') ? 'menu-open' : '' }} || {{ request()->routeIs('customer.report*') ? 'menu-open' : '' }}">
                        <a href="#"
                            class="nav-link {{ request()->routeIs('task.report*') ? 'active' : '' }} || {{ request()->routeIs('customerLead.report*') ? 'active' : '' }}
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('task.report') }}"
                                    class="nav-link  {{ request()->routeIs('task.report') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Task</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('customerLead.report') }}"
                                    class="nav-link {{ request()->routeIs('customerLead.report') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Lead</p>
                                </a>
                            </li>
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('customer.report') }}"
                                    class="nav-link {{ request()->routeIs('customer.report') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Customer</p>
                                </a>
                            </li>
