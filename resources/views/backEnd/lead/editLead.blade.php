                                        ...
                                        <div class="row">
                                            <div class="col-xl-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="{{ $lead->name }}" class="form-control"
                                                        id="name" name="name">
                                                </div>
                                                            ...
                                                            <select class="form-control" name="team_leader_id"
                                                                ...
                                                                @foreach ($teamLeader as $leader)
                                                                    <option value="{{ $leader->id }}"
                                                                        {{ $leader->id == $lead->team_leader_id ? 'selected' : '' }}>
                                                                        {{ $leader->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            <select class="form-control" name="sales_people_id"
                                                                ...
                                                                @foreach ($salesPerson as $person)
                                                                    <option value="{{ $person->id }}"
                                                                        {{ $person->id == $lead->sales_people_id ? 'selected' : '' }}>
                                                                        {{ $person->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
