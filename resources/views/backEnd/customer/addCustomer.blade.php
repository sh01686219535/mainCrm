                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="marriageDay" name="marriageDay">
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                        <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 d-flex mt-4">
                                        ...
                                        <div class="col-md-2">
                                            <input class="mx-1" type="checkbox" id="Installment" name="installment"
                                                value="Installment">
                                        ...
                                        <div class="col-md-2">
                                            <input class="mx-1" type="checkbox" id="half_yearly" name="half_yearly"
                                                value="Half_yearly">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="mainAmount" name="mainAmount"
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="referenceCellNumerA"
                                                name="referenceCellNumerA" placeholder="Enter Reference Cell Number(A)">
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="referenceCellNumerB"
                                                name="referenceCellNumerB" placeholder="Enter Reference Cell Number(B)">
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                        <div class="form-group">
