        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <form action="{{ route('task.update',$task->id) }}" method="post" class="form-demo">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    name="lead_id">
                                        ...
                                        @foreach ($lead as $item)
                                            <option value="{{ $item->id }}" {{ $item->id == $task->lead_id ? 'selected' : '' }}>{{ $item->name }}</option>
                                        @endforeach
                                    </Select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="team_leader_id" id="teamLeader">
                                        ...
                                        @foreach ($teamLeader as $value)
                                            <option value="{{ $value->id }}"{{ $value->id == $task->team_leader_id ? 'selected' : '' }}>{{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sales_people_id"
                                        ...
                                        @foreach ($salesPerson as $value)
                                            <option value="{{ $value->id }}"{{ $value->id == $task->sales_people_id ? 'selected' : '' }}>{{ $value->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" value="{{ \Carbon\Carbon::parse($task->start_date)->format('Y-m-d') }}" class="form-control" id="start_date" name="start_date">
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
                                <div class="form-group">
                                    <label for="due_date">Due Date</label>
                                    <input type="date" value="{{ \Carbon\Carbon::parse($task->due_date)->format('Y-m-d') }}"class="form-control" id="due_date"
                                        name="due_date">
                                </div>
                            </div>
                            <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
